...
* **基础镜像软件栈**：Ubuntu 22.04 / Python 3.10 / PyTorch 2.1.2 / CUDA 11.8
...
* **实现目标**：由于传统视觉算法难以区分“坐着阅读与无明显活动”、“与来访者交谈与独自看电视”等复杂语义。本任务要求在轻量规则或异常行为触发后，截取 **10—30秒关键视频片段** 或 **8—24帧代表性关键帧画面** 送入 Qwen2.5-VL。
* **数据资产对接要求**：
